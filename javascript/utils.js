...
addClassSVG = function (cl, obj) {
    var c = typeof obj.attr("class") != "undefined" ? obj.attr("class") : "";
    if(c.search(cl) > -1) return;
    obj.attr("class", c + " " + cl);
}
removeClassSVG = function (cl, obj) {
    var c = typeof obj.attr("class") != "undefined" ? obj.attr("class") : "";
    if(c.search(cl) > -1)
        obj.attr("class", c.replace(cl, ""));
}
