LevelMeter = new Class({
    ...
    initialize: function (options) {
        ...
        this.element.addClass("level-meter");
        ...
        this._peak = new Element("div.peak").inject(this.element);
        this._peak_label = new Element("div.peak-label").inject(this._peak);
        this._mask3  = new Element("div.mask.mask3").inject(this._bar);
        this._mask4  = new Element("div.mask.mask4").inject(this._bar);
        ...
        switch(key) {
            ...
            case "clip":
                ...
                if(!hold && value) {
                    ...
                    this.element.addClass("clipping");
                    this.__state.set("state", 1);
                } else {
                    this.element.removeClass("clipping");
