var MeterBase = new Class({
    ...
    initialize: function (options, hold) {
        ...
        this.element = new Element("div.toolkit-meter-base", {
            "id":    this.options.id
        });
        ...
        this._mask1  = new Element("div.toolkit-mask.toolkit-mask1").inject(this._bar);
        this._mask2  = new Element("div.toolkit-mask.toolkit-mask2").inject(this._bar);
