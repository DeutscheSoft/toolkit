Scale = new Class({
    ...
    initialize: function (options, hold) {
        ...
        this.element = new Element("div.toolkit-scale", {
            "id":    this.options.id
        });
    ...
    draw_label: function (val, cls) {
        ...
        var label = new Element("span.toolkit-label", { html: this.options.labels(val), style: "position: absolute; display: block; float: left" });
