...
w.TK.Pager = w.Pager = $class({
    ...
    add_page: function (button, content, position, options) {
         ...
         * @param {Int|Undefined} position - The position to add the new page to. If avoided the page is added to the end of the list
    ...
    remove_page: function (page) {
        /** @method remove_page
         * @param {Int|Container} page - The container to remove. Either a position or the #Container widget generated by add_page
